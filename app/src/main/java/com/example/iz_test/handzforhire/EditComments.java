...
public class EditComments extends Activity implements SimpleGestureFilter.SimpleGestureListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rating_lay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(EditComments.this,ReviewRating.class);
    ...
    private void onResponserecieved(String jsonobject, int requesttype)
    {
        ...
        try {
            ...
            {
                Intent intent=new Intent(EditComments.this,ProfilePage.class);
