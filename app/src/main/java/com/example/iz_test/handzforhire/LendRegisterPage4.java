...
public class LendRegisterPage4 extends Activity{
    ...
    String value = "HandzForHire@~";
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            dialog = new Dialog(LendRegisterPage4.this);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (error instanceof TimeoutError ||error instanceof NoConnectionError) {
                            final Dialog dialog = new Dialog(LendRegisterPage4.this);
    ...
    public void onResponserecieved(String jsonobject, int requesttype) {
        ...
        try {
            ...
            if(status.equals("success"))
            {
                ...
                Intent i = new Intent(LendRegisterPage4.this,LendProfilePage.class);
