...
public class LendLeaveComments extends Activity implements SimpleGestureFilter.SimpleGestureListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rating_lay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(LendLeaveComments.this,ReviewRating.class);
    ...
    private void post() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (error instanceof TimeoutError ||error instanceof NoConnectionError) {
                            final Dialog dialog = new Dialog(LendLeaveComments.this);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put(KEY_LOGINUSERID,employee_id);
    ...
    private void onResponserecieved(String jsonobject, int requesttype)
    {
        ...
        try {
            ...
            {
                Intent intent=new Intent(LendLeaveComments.this,ProfilePage.class);
