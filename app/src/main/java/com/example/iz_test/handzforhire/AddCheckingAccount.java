...
public class AddCheckingAccount extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        default_account.setTypeface(tf);
        add_account.setTypeface(tf);

        String fontPath1 = "fonts/calibri.ttf";
        Typeface tf1 = Typeface.createFromAsset(getAssets(), fontPath1);
        account_name.setTypeface(tf1);
        bank_number.setTypeface(tf1);
        checking_account_number.setTypeface(tf1);
        ...
        try {
            ...
            if(status.equals("success"))
            {
                ...
                dialogButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        dialog.dismiss();
                        Intent i = new Intent(AddCheckingAccount.this,ManagePaymentOptions.class);
                        i.putExtra("userId",user_id);
                        startActivity(i);
                        finish();
                    }
